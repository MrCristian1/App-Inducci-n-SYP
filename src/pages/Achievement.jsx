...
import { faArrowRight, faAward, faScroll, faBriefcase, faGem, faUsersCog, faSitemap, faUsers, faStar, faExclamationTriangle } from '@fortawesome/free-solid-svg-icons'
...
const Achievement = () => {
  ...
  useEffect(() => {
    ...
    // }
    //
    // Generar estrellas para el nivel 1, 2, 3, 4, 5, 6 y 7 (políticas, funciones empresariales, valores, jerarquía, comités, accidentes y calidad)
    if (levelIdNum === 1 || levelIdNum === 2 || levelIdNum === 3 || levelIdNum === 4 || levelIdNum === 5 || levelIdNum === 6 || levelIdNum === 7) {
